...
$sql = "SELECT * FROM beats WHERE nombre LIKE '%$searchTerm%' LIMIT $offset, $registrosPorPagina";
$resultado = mysqli_query($conexion, $sql);
$sql2 = "SELECT COUNT(*) AS totalCategorias FROM beats";
...
<body class="home-main header-fixed">
    ...
    <div class="wrapper">
                    ...
                    <div class="col-12">
                        <div class="header__body">
                            <div class="header__logo">
                                <a href="index.html">
                                    <img id="site-logo" src="assets/images/logo/logo.png"
                                        alt="LOGO" height="130"
                                        data-retina="assets/images/logo/logo.png" data-width="160"
                                        data-height="38">
                                </a>
                            </div>
                            ...
                            <div class="header__right">
                                <nav id="main-nav" class="main-nav">
                                    <ul id="menu-primary-menu" class="menu">
                                        ...
                                        <!--<li class="menu-item">
                                        <a href="competidores.html">Competidores</a>
                                    </li>
                                    <li class="menu-item">
                        ...
                        <div class="list">
                            <?php while ($f = mysqli_fetch_array($resultado)) { ?>
                                <div class="blog-box-2">
                                    <div class="image">
                                        <a href="">
                                            <img src="assets/images/layouts/portada.png" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/6XjsXIb1DUhsmhflFAODv3?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe></div>
                            ...
                            <div class="blog-box-2">
                                <div class="image">
                                    <a href="">
                                        <img src="assets/images/layouts/portada2.png" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="content">
                                    ...
                                    <a class="title" href="">NOMBRE BEAT</a>
                                    <p class="text">Genero</p>
                                    <link rel="alternate" type="application/json+oembed" href="https://open.spotify.com/intl-es/track/6VpnpePeNlOmzUR3r5Ydrk?si=2ca0148d33494ae1" />
                                    <iframe style="border-radius:12px" src="https://open.spotify.com/embed/album/2va9pYOn9GwdRjamuvCewE?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                                    <div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="" title="Andres  Zandú" target="_blank" style="color: #cccccc; text-decoration: none;">Andres Zandú</a> · <a href="" title="" target="_blank" style="color: #cccccc; text-decoration: none;"></a></div>
                                </div>
                            </div>
        ...
        SELECT categorias.id, categorias.nombre, seccion.descrip, categorias.id_seccion, 
               (SELECT COUNT(*) FROM beats WHERE beats.id_categoria = categorias.id) AS video_count
        FROM categorias
        INNER JOIN seccion ON categorias.id_seccion = seccion.id
        WHERE categorias.id_seccion = '1'
    ");
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer__bottom">
                            <a href="index.html" class="logo"><img src="assets/images/logo/logo.png" height=80 alt="LOGO"></a>

                            <div class="center mb--30">
                                <ul class="list">
                                    <li><a href="index.html">Principal</a></li>
                                    <li><a href="index.html">Nosotros</a></li>
                                    <li><a href="index.html">Historias</a></li>
                                    <li><a href="index.html">Calendario</a></li>
                                    <li><a href="index.html">Contacto</a></li>
                                </ul>
                                <p><a href="https://mbermu.online/">MB</a></p>
                            </div>
