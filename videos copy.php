                    ...
                    <div class="bloglist__main">
                        ...
                        <div class="sidebar">
                            <div class="widget-sidebar category">
                                ...
                                <ul>
                                    <li><a href="#">nombre <span>(18)</span></a></li>
                                    <li><a href="#">nombre <span>(57)</span></a></li>
                                    <li><a href="#">nombre <span>(5)</span></a></li>
                                    <li><a href="#">nombre <span>(9)</span></a></li>
                                    <li><a href="#">nombre <span>(3)</span></a></li>
                                    <li><a href="#">nombre <span>(81)</span></a></li>
                                    <li><a href="#">nombre <span>(42)</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer__bottom">
                            <a href="index.html" class="logo"><img src="assets/images/logo/logo.png" height=80
                                    alt="LOGO"></a>
